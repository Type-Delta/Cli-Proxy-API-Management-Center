...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'analyticsEnabled',
    sectionId: 'logging',
    labelKey: L('sections.analytics.enabled'),
    hintKey: L('sections.analytics.enabled_desc'),
    yamlKeys: ['analytics', 'enabled'],
    keywords: ['cpauk', 'durable usage'],
  },
  {
    fieldId: 'analyticsPath',
    sectionId: 'logging',
    labelKey: L('sections.analytics.path'),
    hintKey: L('sections.analytics.path_hint'),
    yamlKeys: ['analytics', 'path'],
    keywords: ['sqlite', 'database'],
  },
  {
    fieldId: 'analyticsQueueCapacity',
    sectionId: 'logging',
    labelKey: L('sections.analytics.queue_capacity'),
    hintKey: L('sections.analytics.queue_capacity_hint'),
    yamlKeys: ['analytics', 'queue-capacity'],
  },
  {
    fieldId: 'analyticsBatchSize',
    sectionId: 'logging',
    labelKey: L('sections.analytics.batch_size'),
    hintKey: L('sections.analytics.batch_size_hint'),
    yamlKeys: ['analytics', 'batch-size'],
  },
  {
    fieldId: 'analyticsFlushInterval',
    sectionId: 'logging',
    labelKey: L('sections.analytics.flush_interval'),
    hintKey: L('sections.analytics.flush_interval_hint'),
    yamlKeys: ['analytics', 'flush-interval'],
  },
  {
    fieldId: 'analyticsHotRetentionDays',
    sectionId: 'logging',
    labelKey: L('sections.analytics.hot_retention_days'),
    hintKey: L('sections.analytics.hot_retention_days_hint'),
    yamlKeys: ['analytics', 'hot-retention-days'],
  },
  {
    fieldId: 'analyticsCircuitFailureThreshold',
    sectionId: 'logging',
    labelKey: L('sections.analytics.circuit_failure_threshold'),
    hintKey: L('sections.analytics.circuit_failure_threshold_hint'),
    yamlKeys: ['analytics', 'circuit-failure-threshold'],
  },
  {
    fieldId: 'analyticsMaxStorageBytes',
    sectionId: 'logging',
    labelKey: L('sections.analytics.max_storage_bytes'),
    hintKey: L('sections.analytics.max_storage_bytes_hint'),
    yamlKeys: ['analytics', 'max-storage-bytes'],
  },
  {
    fieldId: 'analyticsMinFreeBytes',
    sectionId: 'logging',
    labelKey: L('sections.analytics.min_free_bytes'),
    hintKey: L('sections.analytics.min_free_bytes_hint'),
  ...
  },
  {
    ...
    hintKey: L('sections.analytics.store_credential_id_desc'),
    yamlKeys: ['analytics', 'privacy', 'store-credential-id'],
    keywords: ['credential hash', 'privacy'],
  },
  {
    fieldId: 'analyticsViewerTrustedProxyCidrs',
    sectionId: 'logging',
    labelKey: L('sections.analytics.trusted_proxy_cidrs'),
    hintKey: L('sections.analytics.trusted_proxy_cidrs_hint'),
    yamlKeys: ['analytics', 'viewer', 'trusted-proxy-cidrs'],
    keywords: ['shared views', 'https', 'reverse proxy'],
  },
  {
    fieldId: 'analyticsViewerAllowLoopbackHttp',
    sectionId: 'logging',
    labelKey: L('sections.analytics.allow_loopback_http'),
    hintKey: L('sections.analytics.allow_loopback_http_desc'),
    yamlKeys: ['analytics', 'viewer', 'allow-loopback-http'],
    keywords: ['shared views', 'localhost', 'development'],
  },
  // ── quota ─────────────────────────────────────────────────────────────────
  {
